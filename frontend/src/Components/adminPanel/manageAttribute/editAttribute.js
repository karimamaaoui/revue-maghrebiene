    ...
    useEffect(() => {
      ...
      useEffect(() => {
        const fetching = async () => {
          ...
          const { data } = await axios.get(`http://localhost:5000/api/attribute/getattribute/${id}`,config);
        ...
        formData.append('label', label);
         ...
         const config = {
          ...
          return  await axios.put(
            `http://localhost:5000/api/attribute/update/${id}`, formData,config).then((res) => {
                            ...
                            <div className="col-md-8" style={{ marginTop: '50px' }}>
                                <div className='container'>
                                    <div id="content" className="p-6 p-md-10 pt-12">
                                        ...
                                        <br/>
                                            <h3 className="fieldset-title">Update Theme</h3>
