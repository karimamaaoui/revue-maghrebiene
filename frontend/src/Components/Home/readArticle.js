...
export default function AddPost() {
    ...
    const [requiredItemLike, setRequiredItemLike] = useState(0);
    ...
    const replaceModalItemLike = (id) => {
        handleShowLike()
        setRequiredItemLike(id)
    }
                                                                    ...
                                                                    async () => {
                                                                        {
                                                                            datas.like.length != 0 ?
                                                                                <div>
                                                                                    {replaceModalItemLike(datas._id)}

                                                                                </div>
                                                                                :
                                                                                history(`/b/${datas._id}`)
                                                                        }
                                                                    }}><span class="fa fa-like"></span>{datas?.like?.length} Like(s)</button>
                                                                <Modal show={showLike} onHide={handleCloseLike}>
